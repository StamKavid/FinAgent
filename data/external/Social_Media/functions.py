...
df_concat_tweet = pd.read_parquet('c:/Users/Stamatis/Desktop/MLCryptoPredictor/MLCryptoPredictor/data/external/Social_Media/files/Bitcoin_tweets.parquet.gzip')
